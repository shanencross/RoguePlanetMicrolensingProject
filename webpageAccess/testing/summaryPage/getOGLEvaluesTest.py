...
def printMOAvalues(eventName):
	...
	magValues = getMag_MOA(eventPageSoup)
...
def printOGLEvalues(eventName):
	...
	print "Tmax:", getValueString(TmaxValues)
	print "tau:", getValueString(tauValues)
	print "u0:", getValueString(u0Values)
